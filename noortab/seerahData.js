...
const seerahEntries = [
    ...
    },
    {
        ...
        story: "Did you know Fatimah al-Fihri founded the world's first university?",
        sunnah: "Seeking knowledge is a duty upon every Muslim (Sunan Ibn Majah 224).",
        link: "https://sunnah.com/ibnmajah:224",
        quiz: {
            question: "When the Prophet ﷺ and Abu Bakr (RA) left Makkah, how many days did they hide in the Cave of Thawr?",
            options: ["1", "3", "5", "7"],
            correctIndex: 1
        }
    },
